...
<head>
    ...
    <title>Laundry Underground</title>
    <!-- Bootstrap Core CSS -->
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li>
                        <a class="profile-pic" href="#"> <img src="../assets/plugins/images/users/bg-01.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">ADMIN</b></a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-header -->
